...
export const DndProvider = forwardRef(function DndProvider({ children, springConfig = {}, minDistance = 0, activationDelay = 0, disabled, hapticFeedback, onDragEnd, onBegin, onUpdate, onFinalize, style, debug, scrollableContentOffset}, ref) {
        ...
        const panGesture = Gesture.Pan()
            ...
            if (state !== State.FAILED && onDragEnd) {
                ...
                if (dropActiveId !== null) {
                    ...
                    const [targetX, targetY] = [droppableLayouts.value[dropActiveId].value.x - draggableLayouts.value[activeId].value.x, droppableLayouts.value[dropActiveId].value.y - draggableLayouts.value[activeId].value.y]
